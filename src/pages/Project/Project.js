            ...
            <div className="col-lg-6 project-t ">
                <Fade bottom cascade>
                    <div>
                        ...
                        <p className="p"><b>Tech Stack : </b>{props.feature}</p>                        
                        <p className="p"><b>{props.tech}</b></p>

                        <button ><span> <a id="a" target="_blank" href={props.frontend}>Frontend</a></span></button>
                        <button ><span> <a id="a" target="_blank" href={props.backend}>Backend</a></span></button>
                        <button ><span> <a id="b" target="_blank" href={props.deploy}>Live</a></span></button>
                    </div>
                </Fade>
            </div>
